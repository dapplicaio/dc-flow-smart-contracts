...
// This script gets the serial number of an item
// by borrowing a reference to the nft
// and returning its serial number

// serial number is the number of nfts minted per a specific item type
...
// Returns: UInt64
// The serialNumber associated with an item with a specified ID
